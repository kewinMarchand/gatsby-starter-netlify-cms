...
import {withStyles, Card, CardActions, CardContent, CardMedia, Grid, Typography  } from '@material-ui/core';
import Container from './partials/Container';
import SectionHeader from './partials/SectionHeader';
import Cta from './partials/Cta';
import avatar from '../img/delphinewitkowski.jpg'
...
class About extends React.Component {
  ...
  render() {
    ...
    return (
        <Container id="about" bgColor="gradient" alignItems="center">
            <SectionHeader 
